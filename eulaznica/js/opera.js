...
function upisiBalet(x) {
    ...
    //Filtriramo po vrsti dogadjaja -opera 
    ...
    for (let i = 0; i < filterBalet.length; i++) {
        ...
        omotacSlike.innerHTML = '<img id="opera"' + (i + 1) + ' class="linkovi" alt="opera"' + (i + 1) + ' src="../slikezavrsni/opera' + (i + 1) + '.jpg"><br><span>' + filterBalet[i].naziv + '</span> <br> Cena: <span>' + filterBalet[i].cena + '</span>   <br>Količina <input type="number" min="0" max="20" placeholder="0" id="rezervacija' + i + '"><br>';
